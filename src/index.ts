...
if (ApplePaySession) {
    PaymentRequest = class {
      ...
      private convertPaymentResponse(payment: ApplePayJS.ApplePayPayment): any {
        let shippingAddress = this.convertPaymentAddress(payment.billingContact);
        let billingAddress = this.convertPaymentAddress(payment.shippingContact);
        let response = {
          details: {
            billingAddress: billingAddress
          },
          methodName: payment.token.paymentMethod.network,
          ...
          payerPhone: payment.billingContact.phoneNumber,
